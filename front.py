...
Gulcose=st.number_input("Enter the gulcose(in number)")
...
if st.button('diabetes'):
   st.write(model.predict([[Pregnancies,Gulcose,BloodPressure,SkinThickness,Insulin,BMI,DiabetesPedigreeFunction,Age]]))
